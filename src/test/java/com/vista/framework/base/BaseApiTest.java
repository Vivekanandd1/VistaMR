...
public abstract class BaseApiTest {
    ...
    public void setUp() {
        Allure.step("API Test Setup: Initialize Client", () -> {
            ...
            AllureReportHelper.attachEnvironmentInfo("API Base URL", baseUrl);
    ...
    public void tearDown() {
        Allure.step("API Test Teardown: Clean Up", () -> {
    ...
    protected String getOAuth2Token(String clientId, String clientSecret) {
        return Allure.step("Get OAuth2 Token", () -> {
